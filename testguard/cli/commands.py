...
def cmd_run(argv: list[str], cwd: str, run_options: RunOptions) -> int:
    ...
    run_id = engine.run_command(
        ...
        warn_memory_mebibytes=run_options.warn_memory_mebibytes,
        max_memory_mebibytes=run_options.max_memory_mebibytes,
        max_runtime_seconds=run_options.max_runtime_seconds,
        disk_write_mebibytes_per_second=run_options.disk_write_mebibytes_per_second,
        disk_write_sustain_seconds=run_options.disk_write_sustain_seconds,
